...
X1 <- ar1xar1.sim.cond(N, R=2, C=500, sigma2, rho.r=0, rho.c)
...
X1 <- ar1xar1.sim.cond(N, R=500, C=2, sigma2, rho.r, rho.c=0.0)
prettyPrintSummary(apply(X1, 3, function(Xi){
  acf(Xi[,1], lag.max=1, type="correlation", plot=FALSE)$acf[2]
}))
```
...
X1 <- ar1xar1.sim.cond(N, R, C, sigma2, rho.r, rho.c)
prettyPrintSummary(apply(X1, 3, function(Xi){
  acf(Xi[1,], lag.max=1, type="correlation", plot=FALSE)$acf[2]
}))
prettyPrintSummary(apply(X1, 3, function(Xi){
