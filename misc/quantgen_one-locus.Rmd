...
* $\forall j \in \{2,\ldots,R\}, \; a_{1j} = \frac{G_{jj} - G_{11}}{2}$

The remaining $(R-1)(R-2)/2$=`r (R-1)*(R-2)/2` additive effects can be obtained like this:

* $\forall i,j \in \{2,\ldots,R\}, \; a_{ij} = a_{1j} - a_{1i}$
...
As for the two-allele case: $\forall i,j \in \{1,\ldots,R\}, \; G_{ij} = \text{E}[G_{ij}] + \alpha_i + \alpha_j + \delta_{ij}$.
