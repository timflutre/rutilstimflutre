...
- $q'_i$: fraction *derived* from entities of the ancestral set that have the type $i$ (it is not necessarily equal to the fraction of the descendant set that have the type $i$)
