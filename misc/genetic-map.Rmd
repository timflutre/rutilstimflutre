...
nb.genos <- 1*10^3
nb.chrs <- 2
chr.len.phy <- 10^6     # chromosome physical length in base pairs
mu <- 10^(-8)           # neutral mutation rate in events / base / generation
...
m <- 10^(-5)            # fraction of a pop replaced from other pops each gen
...
```{r}
cmd <- "group 0.3 5" # params chosen by trial and error
