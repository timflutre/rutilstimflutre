...
* shape $a_0$ and rate $b_0$

* mean $m_0$ and precision $t_0$
...
* $\mu | \boldsymbol{y}, \tau \sim \mathcal{N}(m_N, t_N)$

with:

$a_N = a_0 + N/2$

$b_N = b_0 + \frac{1}{2} \sum_n (y_n - \bar{y})^2 + \frac{t_0 N (y_n - \bar{y})^2}{2 (t_0 + N)}$
